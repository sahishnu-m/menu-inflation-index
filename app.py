...
# Dataset selection.
#
# The most important control on the page. Real and simulated observations live
# in the same database under different labels and are never combined, so the
# first thing the dashboard settles is which of the two it is showing.
# ---------------------------------------------------------------------------
...
if REAL in datasets and len(observations_for(REAL)["period"].unique()) >= 2:
...
if dataset == SIMULATED:
    st.warning(
        ...
        "before months of real collection have happened. They describe nothing "
        "about actual Reno prices. Real and simulated observations are stored "
        "under separate labels and are never combined.",
        icon=None,
    )
